package com.addukkanapp.uis.activity_filter_search;
...
import com.addukkanapp.adapters.CategoryFilterAdapter;
...
public class FilterSearchActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        //categoryDataModelDataList.addAll(sub_departments.getSub_departments());
        //departments.add(categoryDataModelDataList.get(pos).getId());
        binding.setLang(lang);
        binding.recViewCountry.setLayoutManager(new LinearLayoutManager(this));
        adapter = new CategoryFilterAdapter(this, categoryDataModelDataList, -1);
...
//                categoryDataModelDataList.clear();
//                categoryDataModelDataList.addAll(sub_departments.getSub_departments());
                adapter = new CategoryFilterAdapter(FilterSearchActivity.this, categoryDataModelDataList, -1);
                binding.recViewCountry.setAdapter(adapter);
                adapter.notifyDataSetChanged();
                list.clear();
                companyAdapter = new CompanyAdapter(FilterSearchActivity.this, list);
                binding.recViewCompany.setAdapter(companyAdapter);
                getCompanies();
                dataList.clear();
                brandAdapter = new BrandAdapter(FilterSearchActivity.this, dataList);
                binding.recViewBrand.setAdapter(brandAdapter);
                getBrands();
    ...
    public void addDepartid(MainCategoryDataModel.Data subCategoryDataModel) {
